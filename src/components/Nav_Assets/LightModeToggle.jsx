...
export const LightModeToggle = () => {
    ...
    const lightModeIcon = isLightMode ? "/Portafolio/img/assets/dark.png" : "/Portafolio/img/assets/lightness.png";
    return (  
    <div id="toggle-dark-mode">
        <div onClick={toggleTheme}>
            <img className="animation_scale img_assets" id="lightnes" src={lightModeIcon}
